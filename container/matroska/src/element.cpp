...
static element_identify meta_seek_head_identifies[] = {
        element_identify(element_type::GENERIC_TYPE, &meta_seek_head::seeks, meta_seek_head::SEEK, 0x4DBB)
};
...
static element_identify segment_chapter_translate_identifies[] = {
        element_identify(element_type::GENERIC_TYPE, &segment_chapter_translate::edition_uids, segment_chapter_translate::EDITION_UID, 0x69FC),
...
static element_identify segment_info_identifies[] = {
        ...
        element_identify(element_type::GENERIC_TYPE, &segment_info::families, segment_info::FAMILY, 0x4444),
        element_identify(element_type::GENERIC_TYPE, &segment_info::chapter_translates, segment_info::CHAPTER_TRANSLATE, 0x6924),
...
static element_identify cluster_silent_tracks_identifies[] = {
        element_identify(element_type::GENERIC_TYPE, &cluster_silent_tracks::numbers, cluster_silent_tracks::NUMBER, 0x58D7)
};
...
static element_identify cluster_block_additions_identifies[] = {
        element_identify(element_type::GENERIC_TYPE, &cluster_block_additions::block_more, cluster_block_additions::BLOCK_MORE, 0xA6)
};
...
static element_identify cluster_slices_identifies[] = {
        element_identify(element_type::GENERIC_TYPE, &cluster_slices::time_slices, cluster_slices::TIME_SLICE, 0xE8)
};
...
static element_identify cluster_block_identifies[] = {
        ...
        element_identify(element_type::GENERIC_TYPE, &cluster_block::additions, cluster_block::ADDITIONS, 0x75A1),
        ...
        element_identify(element_type::GENERIC_TYPE, &cluster_block::slices, cluster_block::SLICES, 0x8E)
};
...
static element_identify cluster_identifies[] = {
        ...
        element_identify(element_type::GENERIC_TYPE, &cluster::silent_tracks, cluster::SILENT_TRACKS, 0x5854),
        ...
        element_identify(element_type::GENERIC_TYPE, &cluster::simple_blocks, cluster::SIMPLE_BLOCK, 0xA3),
        element_identify(element_type::GENERIC_TYPE, &cluster::block_group, cluster::BLOCK_GROUP, 0xA0)
};
...
static element_identify track_translate_identifies[] = {
        element_identify(element_type::GENERIC_TYPE, &track_translate::edition_uids, track_translate::EDITION_UID, 0x66FC),
...
static element_identify track_video_color_identifies[] = {
        ...
        element_identify(element_type::GENERIC_TYPE, &track_video_color::mastering_metadata, track_video_color::MASTERING_METADATA, 0x55D0)
};
...
static element_identify track_video_identifies[] = {
        ...
        element_identify(element_type::GENERIC_TYPE, &track_video::color, track_video::COLOR, 0x55B0)
};
...
static element_identify track_operation_combine_planes_identifies[] = {
        element_identify(element_type::GENERIC_TYPE, &track_operation_combine_planes::track_planes, track_operation_combine_planes::TRACK_PLANE, 0xE4)
};
...
static element_identify track_operation_join_blocks_identifies[] = {
        element_identify(element_type::GENERIC_TYPE, &track_operation_join_blocks::uids, track_operation_join_blocks::UID, 0xED)
};
...
static element_identify track_operation_identifies[] = {
        element_identify(element_type::GENERIC_TYPE, &track_operation::combine_planes, track_operation::TRACK_COMBINE_PLANES, 0xE3),
        element_identify(element_type::GENERIC_TYPE, &track_operation::join_blocks, track_operation::TRACK_JOIN_BLOCKS, 0xE9)
};
...
static element_identify track_content_encoding_identifies[] = {
        ...
        element_identify(element_type::GENERIC_TYPE, &track_content_encoding::compression, track_content_encoding::COMPRESSION, 0x5034),
        element_identify(element_type::GENERIC_TYPE, &track_content_encoding::encryption, track_content_encoding::ENCRYPTION, 0x5035)
};
...
static element_identify track_content_encodings_identifies[] = {
        element_identify(element_type::GENERIC_TYPE, &track_content_encodings::content_encodings, track_content_encodings::CONTENT_ENCODING, 0x6240)
};
...
static element_identify track_entry_identifies[] = {
        ...
        element_identify(element_type::GENERIC_TYPE, &track_entry::overlays, track_entry::OVERLAY, 0x6FAB),
        ...
        element_identify(element_type::GENERIC_TYPE, &track_entry::translate, track_entry::TRANSLATE, 0x6624),
        element_identify(element_type::GENERIC_TYPE, &track_entry::video, track_entry::VIDEO, 0xE0),
        element_identify(element_type::GENERIC_TYPE, &track_entry::audio, track_entry::AUDIO, 0xE1),
        element_identify(element_type::GENERIC_TYPE, &track_entry::operation, track_entry::OPERATION, 0xE2),
        element_identify(element_type::GENERIC_TYPE, &track_entry::content_encodings, track_entry::CONTENT_ENCODINGS, 0x6D80)
};
...
static element_identify track_identifies[] = {
        element_identify(element_type::GENERIC_TYPE, &track::entries, track::TRACK_ENTRY, 0xAE)
};
...
static element_identify cue_track_position_identifies[] = {
        ...
        element_identify(element_type::GENERIC_TYPE, &cue_track_position::references, cue_track_position::REFERENCE, 0xDB)
};
...
static element_identify cue_point_identifies[] = {
        ...
        element_identify(element_type::GENERIC_TYPE, &cue_point::track_positions, cue_point::TRACK_POSITIONS, 0xB7)
};
...
static element_identify cue_identifies[] = {
        element_identify(element_type::GENERIC_TYPE, &cue::cue_points, cue::CUE_POINT, 0xBB)
};
...
static element_identify attachment_identifies[] = {
        element_identify(element_type::GENERIC_TYPE, &attachment::attached_files, attachment::ATTACHED_FILE, 0x61A7)
};
...
static element_identify chapter_track_identifies[] = {
        element_identify(element_type::GENERIC_TYPE, &chapter_track::track_numbers, chapter_track::TRACK_NUMBER, 0x89)
};
...
static element_identify chapter_display_identifies[] = {
        ...
        element_identify(element_type::GENERIC_TYPE, &chapter_display::languages, chapter_display::LANGUAGE, 0x437C),
        element_identify(element_type::GENERIC_TYPE, &chapter_display::countries, chapter_display::COUNTRY, 0x437E)
};
...
static element_identify chapter_process_identifies[] = {
        ...
        element_identify(element_type::GENERIC_TYPE, &chapter_process::commands, chapter_process::COMMAND, 0x6911)
};
...
static element_identify chapter_atom_identifies[] = {
        element_identify(element_type::GENERIC_TYPE, &chapter_atom::atoms, chapter_atom::CHAPTER_ATOM, 0xB6),
        ...
        element_identify(element_type::GENERIC_TYPE, &chapter_atom::track, chapter_atom::TRACK, 0x8F),
        element_identify(element_type::GENERIC_TYPE, &chapter_atom::displays, chapter_atom::DISPLAY, 0x80),
        element_identify(element_type::GENERIC_TYPE, &chapter_atom::processes, chapter_atom::PROCESS, 0x6944)
};
...
static element_identify chapter_edition_entry_identifies[] = {
        ...
        element_identify(element_type::GENERIC_TYPE, &chapter_edition_entry::chapter_atoms, chapter_edition_entry::CHAPTER_ATOM, 0xB6),
};
...
static element_identify chapter_identifies[] = {
        element_identify(element_type::GENERIC_TYPE, &chapter::edition_entries, chapter::EDITION_ENTRY, 0x45B9)
};
...
static element_identify tag_target_identifies[] = {
        ...
        element_identify(element_type::GENERIC_TYPE, &tag_target::uids, tag_target::UID, 0x0) // multi type: track 0x63C5, edition 0x63C9, chapter 0x63C4, attachment 0x63C6
};
...
static element_identify simple_tag_identifies[] = {
        element_identify(element_type::GENERIC_TYPE, &simple_tag::tags, simple_tag::SIMPLE_TAG, 0x67C8),
        element_identify(element_type::GENERIC_TYPE, &simple_tag::name, simple_tag::NAME, 0x45A3),
        element_identify(element_type::GENERIC_TYPE, &simple_tag::language, simple_tag::LANGUAGE, 0x447A),
        element_identify(element_type::GENERIC_TYPE, &simple_tag::tag_default, simple_tag::DEFAULT, 0x4484),
        element_identify(element_type::GENERIC_TYPE, &simple_tag::string, simple_tag::STRING, 0x4487),
        element_identify(element_type::GENERIC_TYPE, &simple_tag::bin, simple_tag::BINARY, 0x4485),
};
...
static element_identify tag_identifies[] = {
        element_identify(element_type::GENERIC_TYPE, &tag::target, tag::TARGETS, 0x63C0),
        element_identify(element_type::GENERIC_TYPE, &tag::simple_tags, tag::SIMPLE_TAG, 0x67C8)
};
...
static element_identify tags_identifies[] = {
        element_identify(element_type::GENERIC_TYPE, &tags::tag_list, tags::TAG, 0x7373)
};
